...
namespace K4os.Hash.xxHash
{
    ...
    public partial class XXH32
    {
        ...
        /// <returns>Digest.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe uint DigestOf(void* bytes, int length, uint seed)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe void Reset(ref State state, uint seed = 0)
        {
        ...
        /// <returns>Hash so far.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static unsafe uint Digest(in State state)
        {
            fixed (State* stateP = &state)
            {
