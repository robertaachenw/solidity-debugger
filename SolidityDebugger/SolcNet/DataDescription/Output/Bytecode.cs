...
namespace SolcNet.DataDescription.Output
{
    public class Bytecode
    {
        ...
        /// </summary>
        [JsonProperty("functionDebugData")]
        public Dictionary<string, FunctionDebugData> FunctionDebugData { get; set; }
        ...
        /// </summary>
        [JsonProperty("generatedSources", Required = Required.Default)]
        public JArray GeneratedSources { get; set; }
        ...
        public Dictionary<string /*sol file*/, Dictionary<string/*contract name*/, LinkReference[]>> ImmutableReferences { get; set; }
    }
