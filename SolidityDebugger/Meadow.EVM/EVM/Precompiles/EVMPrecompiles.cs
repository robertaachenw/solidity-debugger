...
namespace Meadow.EVM.EVM.Precompiles
{
    ...
    public abstract class EVMPrecompiles
    {
        ...
        static EVMPrecompiles()
        {
            ...
            _precompiles["0x09"] = Precompile_Blake2f;
        }
        //#endregion
        ...
        private static EVMExecutionResult Precompile_Blake2f(MeadowEVM evm)
        {
            throw new Exception("Not implemented: blake2f precompiled contract");
        }
