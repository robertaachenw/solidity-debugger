...
namespace Meadow.EVM.EVM.Instructions
{
    ...
    public enum InstructionOpcode : byte
    {
        ...
        BYTE = 0x1a,
        // Constantinople
        [OpcodeDescriptor(typeof(InstructionShl), "SHL", 0, 2, 1, "Bitwise left shift operation")]
        [OpcodeBaseGasCost(EthereumRelease.Constantinople, 3)]
        SHL = 0x1b,
        [OpcodeDescriptor(typeof(InstructionShr), "SHR", 0, 2, 1, "Bitwise right shift operation")]
        [OpcodeBaseGasCost(EthereumRelease.Constantinople, 3)]
        SHR = 0x1c,
        [OpcodeDescriptor(typeof(InstructionSar), "SAR", 0, 2, 1, "Bitwise arithmetic (signed) right shift operation")]
        [OpcodeBaseGasCost(EthereumRelease.Constantinople, 3)]
        SAR = 0x1d,
        //#endregion
        ...
        RETURNDATACOPY = 0x3e,
        [OpcodeDescriptor(typeof(InstructionExternalCodeHash), "EXTCODEHASH", 0, 1, 1, "Get hash of an account's code")]
        [OpcodeBaseGasCost(EthereumRelease.Constantinople, 100), OpcodeBaseGasCost(EthereumRelease.Constantinople, 2600)]
        EXTCODEHASH = 0x3f,
        //#endregion
        ...
        [OpcodeBaseGasCost(EthereumRelease.Frontier, 2)]
        GASLIMIT = 0x45,
        [OpcodeDescriptor(typeof(InstructionChainId), "CHAINID", 0, 0, 1, "Get the chain ID")]
        [OpcodeBaseGasCost(EthereumRelease.Istanbul, 2)]
        CHAINID = 0x46,
        ...
        DELEGATECALL = 0xf4,
        [OpcodeDescriptor(typeof(InstructionCreate2), "CREATE2", 0, 4, 1, "Create a new account with associated code")]
        [OpcodeBaseGasCost(EthereumRelease.Constantinople, 32000)]
        CREATE2 = 0xf5,
