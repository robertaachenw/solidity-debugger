...
namespace Meadow.EVM.EVM.Instructions.System_Operations
{
    public class InstructionLog : InstructionBase
    {
        ...
        public override void Execute()
        {
            ...
            var logMemoryStart = Stack.Pop();
            var logMemorySize = Stack.Pop();
            ...
            var topics = new List<BigInteger>();
            ...
            var logMemoryData = Memory.ReadBytes((long)logMemoryStart, (int)logMemorySize);

            // Log our instruction
            var log = new Data_Types.Transactions.Log(Message.To, topics, logMemoryData);
            EVM.State.Log(log, Message);
        }
        //#endregion
    }
}
